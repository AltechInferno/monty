 ...
 * Description: this doubly linked list node structure
 */
...
/**
 * struct instruction_s - this is the opcoode and its function
 * @opcode: the opcode
...
/**
 * struct global_variable - this is the opcoode and its function
 * @file: the opcode
 * @push_arg: a function to handle the opcode
 * @buffer: a pointer to
 * Description: opcode and its function
*/
